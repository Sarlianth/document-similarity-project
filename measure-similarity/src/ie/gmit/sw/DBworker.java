...
public class DBworker implements DBinterface {
	...
	private void init() throws IOException {
		int i = 0;
		// Old path - in case it doesn't work change to full path 
		// C:/Users/Adrian/Desktop/projectOOP/measure-similarity/WebContent/WEB-INF/lib/files
		File dir = new File("./webapps/measure-similarity/WEB-INF/lib/files");
	...
	/*
	 * (non-Javadoc)
	 * @see ie.gmit.sw.DBinterface#getDocuments()
	 */
	...
	/*
	 * Main method, creating an instance of DBworker
	 */
